...
<img src="https://github.com/dmerck7/Basic-Search-App/blob/master/ScreenShot.jpg?raw=true)" width="600">
 ...
 * Consider editable documents
 * Consider heading extraction/formatting based on line length and preceding/post return lines.
 * Consider using a rest based synonym look up API for search terms or building your own.
 * Add AI algorythm and weights
